<?php
    ...
    $query2="SELECT        dw_produzione.dbo.commesse.commessa, dw_produzione.dbo.commesse.descrizione AS descrizione_commessa, DATEPART(yy, GETDATE()) AS year, db_tecnico.dbo.pannelli.codice_pannello, 
                         ...
                         db_tecnico.dbo.pannelli.descrizionetec AS codice_certificato, db_tecnico.dbo.pannelli.resis AS classe, dw_produzione.dbo.lotti.id_materiale, dw_produzione.dbo.lotti.lotto,db_tecnico.dbo.pannelli.descrizione AS descrizione_pannello
