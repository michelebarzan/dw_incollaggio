    ...
    if($result2==TRUE)
    {
        while($row2=sqlsrv_fetch_array($result2))
        {
            ...
            $query="SELECT DISTINCT 
                  TOP (100) PERCENT dw_produzione.dbo.ordini_di_produzione.nome AS ordine_di_produzione, dw_produzione.dbo.distinta_ordini_di_produzione.numero_cabina, db_tecnico.dbo.pannelli.codice_pannello, dbo.pannelli_prodotti.id_distinta, 
                  dbo.pannelli_prodotti.id_pannello_prodotto, dw_produzione.dbo.filtro_pannelli.elettrificato, dw_produzione.dbo.lotti.lotto, dw_produzione.dbo.commesse.commessa, dw_produzione.dbo.commesse.descrizione
