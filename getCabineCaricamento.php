<?php
    ...
    $query2="SELECT DISTINCT TOP (100) PERCENT dw_produzione.dbo.distinta_ordini_di_produzione.numero_cabina, pannelli_caricati.pannelli_caricati, totale_pannelli_ordini_di_produzione.totale_pannelli
            FROM dw_produzione.dbo.ordini_di_produzione INNER JOIN
                                    dw_produzione.dbo.distinta_ordini_di_produzione ON dw_produzione.dbo.ordini_di_produzione.id_ordine_di_produzione = dw_produzione.dbo.distinta_ordini_di_produzione.ordine_di_produzione INNER JOIN
                                        ...
                                        HAVING (distinta_ordini_di_produzione_2.ordine_di_produzione = $id_ordine_di_produzione)) AS pannelli_caricati ON dw_produzione.dbo.distinta_ordini_di_produzione.numero_cabina = pannelli_caricati.numero_cabina INNER JOIN
                                    ...
                                    dw_produzione.dbo.distinta_ordini_di_produzione.numero_cabina = totale_pannelli_ordini_di_produzione.numero_cabina
