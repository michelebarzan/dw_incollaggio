<?php
    ...
    $query2="SELECT DISTINCT 
                                    ...
                                    dw_produzione.dbo.distinta_ordini_di_produzione.numero_cabina, dw_produzione.dbo.distinta_ordini_di_produzione.pannello, dw_produzione.dbo.filtro_pannelli.elettrificato, db_tecnico.dbo.pannelli.profilo, dw_produzione.dbo.filtro_pannelli.configurazione
    ...
    if($result2==TRUE)
    {
        while($row2=sqlsrv_fetch_array($result2))
        {
            ...
            //$pannello["profilo"]=strtoupper($row2['profilo']);
