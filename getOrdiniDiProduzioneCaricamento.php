<?php
    ...
    $query2="SELECT DISTINCT dw_produzione.dbo.ordini_di_produzione.id_ordine_di_produzione, dw_produzione.dbo.ordini_di_produzione.nome AS ordine_di_produzione, dw_produzione.dbo.lotti.id_lotto, dw_produzione.dbo.lotti.lotto, 
                totale_pannelli_ordini_di_produzione.totale_pannelli, pannelli_caricati.pannelli_caricati, CASE WHEN pannelli_caricati = totale_pannelli THEN 'true' ELSE 'false' END AS terminato
